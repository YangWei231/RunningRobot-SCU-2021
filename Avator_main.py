...
color_range = {
    ...
    'green_hole_chest':[(66 , 75 , 53), (79 , 243 , 187)],#yw:过坑的绿色（胸部检测）
    'green_hole_head':[(66 , 108 , 53), (79 , 243 , 168)],#yw:过坑的绿色（头部检测)
    'blue_floor':[(100 , 160 , 140), (109 , 234 , 255)],#yw:蓝色台阶
    'green_floor':[(65 , 81 , 73), (81 , 226 , 158)],#yw:绿色台阶
    'red_floor1':[(0 , 122 , 120), (3, 206 , 233)],#yw:红色台阶   我们取红色台阶需要有两个值
    'red_floor2':[(176, 122 , 120), (179 , 206 , 233)],
    'red_XP1':[(0 , 122 , 92), (3 , 212 , 233)],#yw:红色下坡   他这里取了两个掩模做了或运算  不过这两个掩模的值怎么来的我不清楚。
    'red_XP2':[(176 , 122 , 92), (179 , 212 , 233)],
    ...
    'kick_ball_rec': [(0 , 0 , 89), (176 , 60 , 255)],
    #补充
    'green_bridge': [(63 , 70 , 39), (80 , 255 , 185)],
