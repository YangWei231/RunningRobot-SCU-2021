...
color_range = {
    ...
    'green_hole_chest':[(67 , 108 , 68), (76 , 243 , 155)],
    'green_hole_head':[(67 , 140 , 39), (76 , 255 , 104)],
    ...
    'head_blue_door':[(100 , 117 , 70), (109 , 228 , 129)],
}
...
def hole_recognize():#yw：hole_recognize和hole_recognize_2的区别在于颜色不一样，前者是绿色，后者是蓝色。
    ...
    src = src[int(100):int(400),int(0):int(500)]#yw：这里我记得是Y，X,切片顺序与常识不一样
    src = cv2.GaussianBlur(src, (5, 5), 0)
    hsv_img = cv2.cvtColor(src, cv2.COLOR_BGR2HSV)
